...
const API_GATEWAY_PORT = parseInt(process.env.PORT, 10); // Service Port
...
const registerService = async () => {
    try {
        ...
        await consul.agent.service.register({
            ...
            port: API_GATEWAY_PORT, // The service's running port
            check: {
        ...
        console.log('✅ Service successfully registered in Consul');
