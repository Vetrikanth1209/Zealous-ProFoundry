...
const CONSUL_PORT = parseInt(process.env.CONSUL_PORT, 10) || 443; // Default to 443 if not set
const SERVICE_PORT = parseInt(process.env.PORT, 10) || 7000; // Default to 7000 if not set

// Create a Consul client
const consul = new Consul({
    host: CONSUL_HOST,
    port: CONSUL_PORT,
    secure: true, // Use HTTPS for Render-based Consul
    promisify: true,
});
